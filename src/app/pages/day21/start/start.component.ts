...
@Component({
  selector: 'app-day21-start',
  standalone: true,
  imports: [RouterLink, CodeBlockComponent, CollapsibleComponent],
  template: `
    <div class="lesson-content">
      <div class="page-header">
        <span class="act-label">Day 21 · Starting Point</span>
        <h1>🎬 Get BingeBoard Running</h1>
        <p class="subtitle">The end-of-Day-20 BingeBoard: server-side review queries, plus the Firestore foundation that Day 21 will give real users.</p>
      </div>
      ...
      <section class="lesson-framework">
        ...
        <ul><li>Clone the teaching repository, then enter <code>starters/bingeboard-day21/</code>.</li><li>Run <code>npm install</code>, paste your own Firebase config into <code>src/environments/environment.ts</code>, then run <code>npm start</code>.</li></ul>
        <app-code-block lang="bash" [code]="cloneCommand" />
        <p>Browse it on GitHub: <a href="https://github.com/megabottty/mtech-angular-lab-data-binding/tree/main/starters/bingeboard-day21" target="_blank" rel="noopener">starters/bingeboard-day21</a>.</p>
      </section>
      <section class="lesson-framework">
        <h3>Option B — Bring your own project</h3>
        <p>Expand every source file to copy or compare the exact end-of-Day-20 reference implementation.</p>
      ...
      <section class="lesson-framework"><h3>What this code already does</h3><ul><li><strong>Days 9-17:</strong> routing, guards, real HTTP, typeahead, pipes, and a 404 page.</li><li><strong>Days 18-19:</strong> Firestore reads, watchlist CRUD, and reviews.</li><li><strong>Day 20:</strong> server-side Firestore queries for filtered, sorted review data.</li></ul></section>
      <section class="lesson-framework"><h3>Verify before you start</h3><ul class="task-checklist"><li><span class="checkbox">✅</span> Your Firebase config is present in <code>environment.ts</code>.</li><li><span class="checkbox">✅</span> Your watchlist persists after a reload.</li><li><span class="checkbox">✅</span> A show detail page displays its matching reviews, newest first.</li></ul></section>
      <div class="warning-box">If a check fails, return to the day and act that built it before continuing. Day 21 changes identity and permissions on top of this state.</div>
      <div class="nav-footer"><a routerLink="/day20/lab" class="btn-secondary">← Day 20 Lab</a><a routerLink="/day21/act1" class="btn-primary">Act 1: Firebase Auth Setup →</a></div>
    </div>
  `
})
export class Day21StartComponent {
  cloneCommand = `git clone https://github.com/megabottty/mtech-angular-lab-data-binding.git
cd mtech-angular-lab-data-binding/starters/bingeboard-day21
npm install
...
import { toSignal } from '@angular/core/rxjs-interop';
import {
  Firestore, addDoc, collection, collectionData, limit, orderBy, query, where,
