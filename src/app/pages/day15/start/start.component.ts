...
@Component({
  selector: 'app-day15-start',
  standalone: true,
  imports: [RouterLink, CodeBlockComponent, CollapsibleComponent],
  template: `
    <div class="lesson-content">
      <div class="page-header">
        <span class="act-label">Day 15 · Starting Point</span>
        <h1>🎬 Get BingeBoard Running</h1>
        <p class="subtitle">The exact end-of-Day-14 BingeBoard, ready to run — so you spend today's time on RxJS, not on retyping three days of prior code.</p>
      </div>
      ...
      <section class="lesson-framework">
        ...
        <ul>
          <li><strong>Clone the teaching site's repo</strong>, which includes this starter under <code>starters/bingeboard-day15/</code>.</li>
          <li><strong>Install and run it:</strong> <code>cd starters/bingeboard-day15 && npm install && npm start</code>.</li>
        ...
        <p style="margin-top: 8px;">
          ...
          <a href="https://github.com/megabottty/mtech-angular-lab-data-binding/tree/main/starters/bingeboard-day15" target="_blank" rel="noopener">starters/bingeboard-day15</a>.
        </p>
      </section>
      ...
      <section class="lesson-framework">
        ...
        <p>
          Already have Day 14's BingeBoard building in your own project? You can skip Option A entirely —
      ...
      <section class="lesson-framework">
        ...
        <ul>
          ...
          <li><strong>Day 14:</strong> an <code>error</code> signal with a Retry button that remembers the last search term, a graceful <code>404</code> message on Show Detail, and two independent <code>httpResource()</code>s (show + episodes) instead of a nested subscribe.</li>
        </ul>
      </section>
      ...
      <section class="lesson-framework">
        ...
        <ul class="task-checklist">
          <li><span class="checkbox">✅</span> Search "office" on Browse and see real results.</li>
          <li><span class="checkbox">✅</span> Open a show's detail page and see its episode count load.</li>
          <li><span class="checkbox">✅</span> Visit a show id of <code>999999999</code> and see "That show doesn't exist" — not a generic error.</li>
          <li><span class="checkbox">✅</span> In DevTools, switch the Network tab to Offline, search again, and see the friendly error message — then go back online and click Retry.</li>
        </ul>
      </section>

      <div class="warning-box">
        If any of those checks fail, don't push forward into Day 15 yet — go back to the specific day/act that built it (Day 9 for routing/guards, Day 13 for live search, Day 14 for error handling and <code>httpResource</code>) and get it working first. Everything today builds on top of this exact state.
      </div>

      <div class="nav-footer">
        <a routerLink="/day14/lab" class="btn-secondary">← Day 14 Lab</a>
        <a routerLink="/day15/act1" class="btn-primary">Act 1: The Stream Mental Model →</a>
      </div>
    </div>
  `
})
export class Day15StartComponent {
  cloneCommand = `git clone https://github.com/megabottty/mtech-angular-lab-data-binding.git
cd mtech-angular-lab-data-binding/starters/bingeboard-day15
npm install
npm start`;
...
export class ShowCard {
  ...
  browseStartCode = `import { Component, inject, signal } from '@angular/core';
import { Show } from '../../models/show';
...
export class ShowDetail {
  ...
  statsStartCode = `import { Component } from '@angular/core';
