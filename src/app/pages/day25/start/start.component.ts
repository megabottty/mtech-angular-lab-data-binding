...
@Component({
  selector: 'app-day25-start',
  standalone: true,
  imports: [RouterLink, CodeBlockComponent, CollapsibleComponent],
  template: `
    <div class="lesson-content">
      <div class="page-header">
        <span class="act-label">Day 25 · Starting Point</span>
        <h1>🎬 Get BingeBoard Running</h1>
        <p class="subtitle">The end-of-Day-24 BingeBoard: the Day 23 testing baseline, plus real service, component, HTTP, and guard specs proving Day 24's techniques against this app's own code.</p>
      </div>
      ...
      <section class="lesson-framework">
        ...
        <ul><li>Clone the teaching repository, then enter <code>starters/bingeboard-day25/</code>.</li><li>Run <code>npm install</code>, paste your own Firebase config into <code>src/environments/environment.ts</code>, then run <code>npm start</code>.</li></ul>
        <app-code-block lang="bash" [code]="cloneCommand" />
        <p>Browse it on GitHub: <a href="https://github.com/megabottty/mtech-angular-lab-data-binding/tree/main/starters/bingeboard-day25" target="_blank" rel="noopener">starters/bingeboard-day25</a>.</p>
      </section>
      <section class="lesson-framework">
        <h3>Option B — Bring your own project</h3>
        <p>Expand every source file to copy or compare the exact end-of-Day-24 reference implementation.</p>
      ...
      <section class="lesson-framework"><h3>What this code already does</h3><ul><li><strong>Days 9-17:</strong> routing, guards, real HTTP, typeahead, pipes, and a 404 page.</li><li><strong>Days 18-20:</strong> Firestore reads, watchlist CRUD, authored reviews via a server-side query.</li><li><strong>Day 21:</strong> Google sign-in, per-user watchlists, route guards with return-URL preservation, and Firestore rules that enforce ownership.</li><li><strong>Day 23:</strong> a real, running test suite — <code>toShow()</code>, <code>TimeAgoPipe</code>, and <code>noShouting()</code>, all green.</li><li><strong>Day 24:</strong> a fresh-instance service spec, a component contract spec with DI fakes, an HTTP spec against a testing backend, and a guard spec — four Angular-aware ways to test real app code.</li></ul></section>
      <section class="lesson-framework"><h3>Verify before you start</h3><ul class="task-checklist"><li><span class="checkbox">✅</span> <code>npm install</code> finishes with no ERESOLVE error.</li><li><span class="checkbox">✅</span> <code>npm test</code> shows 9 passing spec files, including <code>show-card.spec.ts</code>, <code>shows.service.spec.ts</code>, and <code>auth.guard.spec.ts</code>.</li><li><span class="checkbox">✅</span> <code>npm start</code> runs and Show Detail still records a recently-viewed entry.</li></ul></section>
      <div class="warning-box">If a check fails, return to the day and act that built it before continuing. Day 25 does not change any app behavior — it audits the tests that already exist and plans the capstone project ahead.</div>
      <div class="nav-footer"><a routerLink="/day24/lab" class="btn-secondary">← Day 24 Lab</a><a routerLink="/day25/act1" class="btn-primary">Act 1: Coverage, Risk, and a Real Test Plan →</a></div>
    </div>
  `
})
export class Day25StartComponent {
  cloneCommand = `git clone https://github.com/megabottty/mtech-angular-lab-data-binding.git
cd mtech-angular-lab-data-binding/starters/bingeboard-day25
npm install
...
export class ShowCard {
  ...
  toggleWatchlist() {
    ...
    { folder: 'Utils and validators', files: [
...
export function noShouting(): ValidatorFn {
  return (control: AbstractControl): ValidationErrors | null => {
    ...
    { folder: 'Tests — carried forward from Days 23-24', files: [
      { path: 'src/app/models/show.spec.ts', lang: 'typescript', code: `import { toShow, TvMazeShow } from './show';
...
describe('toShow', () => {
  ...
  it('passes every field through unchanged on a fully populated show', () => {
    ...
    expect(result.runtime).toBe(42);
      ...
      { path: 'src/app/pipes/runtime.pipe.spec.ts', lang: 'typescript', code: `import { RuntimePipe } from './runtime.pipe';
...
describe('RuntimePipe', () => {
  ...
  it('formats hours and minutes together', () => {
    ...
    expect(result).toBe('1h 30m');
      ...
      { path: 'src/app/pipes/time-ago.pipe.spec.ts', lang: 'typescript', code: `import { TimeAgoPipe } from './time-ago.pipe';
...
describe('TimeAgoPipe', () => {
  ...
  it('formats singular vs. plural weeks', () => {
    ...
    expect(pipe.transform(agoIso(14 * 24 * 60 * 60 * 1000))).toBe('2 weeks ago');
      ...
      { path: 'src/app/utils/binge-level.spec.ts', lang: 'typescript', code: `import { bingeLevel } from './binge-level';
...
describe('bingeLevel', () => {
  ...
  it('returns Marathon above 50 episodes', () => {
    ...
    expect(result).toBe('Marathon');
      ...
      { path: 'src/app/validators/review-validators.spec.ts', lang: 'typescript', code: `import { noShouting } from './review-validators';
...
describe('noShouting', () => {
  ...
  it('does not flag an empty string', () => {
    ...
    expect(result).toBeNull();
      ...
      { path: 'src/app/core/recently-viewed.service.spec.ts', lang: 'typescript', code: `import { TestBed } from '@angular/core/testing';
...
describe('RecentlyViewedService', () => {
  ...
  it('keeps only the last five', () => {
    ...
    expect(svc.recent().map(show => show.id)).toEqual([7, 6, 5, 4, 3]);
      ...
      { path: 'src/app/shared/show-card.spec.ts', lang: 'typescript', code: `import { ComponentFixture, TestBed } from '@angular/core/testing';
...
describe('ShowCard', () => {
  ...
  it('shows a sign-in nudge instead of a watchlist button when signed out', () => {
    ...
    expect(fakeAuth.signIn).toHaveBeenCalled();
      ...
      { path: 'src/app/core/shows.service.spec.ts', lang: 'typescript', code: `import { TestBed } from '@angular/core/testing';
import { provideHttpClient } from '@angular/common/http';
...
describe('ShowsService', () => {
  ...
  it('does not leave a pending request when nothing subscribes', () => {
    ...
    svc.search('unused');
      ...
      { path: 'src/app/core/guards/auth.guard.spec.ts', lang: 'typescript', code: `import { TestBed } from '@angular/core/testing';
