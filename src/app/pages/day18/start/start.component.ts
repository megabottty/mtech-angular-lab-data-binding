...
@Component({
  selector: 'app-day18-start',
  standalone: true,
  imports: [RouterLink, CodeBlockComponent, CollapsibleComponent],
  template: `
    <div class="lesson-content">
      <div class="page-header">
        <span class="act-label">Day 18 · Starting Point</span>
        <h1>🎬 Get BingeBoard Running</h1>
        <p class="subtitle">The exact end-of-Day-17 BingeBoard, ready to run — so you spend today's time on Firebase, not on retyping six days of prior code.</p>
      </div>

      <div class="info-box">
        <strong>Before today, not the starter — a heads up:</strong> Day 18 has you create your own Firebase project, which needs a Google account. If you don't have one signed in and ready, sort that out before you start Act 1 — everything else below works exactly like every prior starter.
      </div>
      ...
      <section class="lesson-framework">
        ...
        <ul>
          <li><strong>Clone the teaching site's repo</strong>, which includes this starter under <code>starters/bingeboard-day18/</code>.</li>
          <li><strong>Install and run it:</strong> <code>cd starters/bingeboard-day18 && npm install && npm start</code>.</li>
        ...
        <p style="margin-top: 8px;">
          ...
          <a href="https://github.com/megabottty/mtech-angular-lab-data-binding/tree/main/starters/bingeboard-day18" target="_blank" rel="noopener">starters/bingeboard-day18</a>.
        </p>
      </section>
      ...
      <section class="lesson-framework">
        ...
        <p>
          Already have Day 17's BingeBoard building in your own project? You can skip Option A entirely —
      ...
      <section class="lesson-framework">
        ...
        <ul>
          ...
          <li><strong>Day 13:</strong> real <code>HttpClient</code> calls against the TVMaze API and a typed + adapted <code>Show</code> model.</li>
          <li><strong>Day 14:</strong> a graceful <code>404</code> message on Show Detail and two independent <code>httpResource()</code>s.</li>
          <li><strong>Day 15:</strong> a live ticker and a <code>topRated()</code> stream on Stats, and a <code>/</code> keyboard shortcut on Browse.</li>
          <li><strong>Day 16:</strong> Browse's search is a full <code>Subject</code> + <code>debounceTime</code> + <code>distinctUntilChanged</code> + <code>switchMap</code> pipeline, plus a <code>/suggest</code> page.</li>
          <li><strong>Day 17:</strong> a <code>runtime</code> pipe and a <code>ratingBadge</code> pipe formatting every show card, and a real <code>**</code> wildcard 404 page.</li>
        </ul>
      </section>
      ...
      <section class="lesson-framework">
        ...
        <ul class="task-checklist">
          <li><span class="checkbox">✅</span> Search "office" on Browse and see results with formatted runtime and a rating verdict on each card.</li>
          <li><span class="checkbox">✅</span> Visit a nonsense URL and see the real 404 page.</li>
          <li><span class="checkbox">✅</span> Visit <code>/stats</code> and confirm the ticker and Top Rated list both work.</li>
          <li><span class="checkbox">✅</span> Have a Google account signed in and ready — you'll need it to create your own Firebase project in Act 1.</li>
        </ul>
      </section>

      <div class="warning-box">
        If any of the app checks fail, don't push forward into Day 18 yet — go back to the specific day/act that built it and get it working first. Everything today builds on top of this exact state.
      </div>

      <div class="nav-footer">
        <a routerLink="/day17/lab" class="btn-secondary">← Day 17 Lab</a>
        <a routerLink="/day18/act1" class="btn-primary">Act 1: Firebase, the Console, and Your Own Project →</a>
      </div>
    </div>
  `
})
export class Day18StartComponent {
  cloneCommand = `git clone https://github.com/megabottty/mtech-angular-lab-data-binding.git
cd mtech-angular-lab-data-binding/starters/bingeboard-day18
npm install
npm start`;
