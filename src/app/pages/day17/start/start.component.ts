...
@Component({
  selector: 'app-day17-start',
  standalone: true,
  imports: [RouterLink, CodeBlockComponent, CollapsibleComponent],
  template: `
    <div class="lesson-content">
      <div class="page-header">
        <span class="act-label">Day 17 · Starting Point</span>
        <h1>🎬 Get BingeBoard Running</h1>
        <p class="subtitle">The exact end-of-Day-16 BingeBoard, ready to run — so you spend today's time on pipes and refactoring, not on retyping five days of prior code.</p>
      </div>
      ...
      <section class="lesson-framework">
        ...
        <ul>
          <li><strong>Clone the teaching site's repo</strong>, which includes this starter under <code>starters/bingeboard-day17/</code>.</li>
          <li><strong>Install and run it:</strong> <code>cd starters/bingeboard-day17 && npm install && npm start</code>.</li>
        ...
        <p style="margin-top: 8px;">
          ...
          <a href="https://github.com/megabottty/mtech-angular-lab-data-binding/tree/main/starters/bingeboard-day17" target="_blank" rel="noopener">starters/bingeboard-day17</a>.
        </p>
      </section>
      ...
      <section class="lesson-framework">
        ...
        <p>
          Already have Day 16's BingeBoard building in your own project? You can skip Option A entirely —
      ...
      <section class="lesson-framework">
        ...
        <ul>
          ...
          <li><strong>Day 14:</strong> a graceful <code>404</code> message on Show Detail and two independent <code>httpResource()</code>s (show + episodes).</li>
          ...
          <li><strong>Day 16:</strong> Browse's search is now a full <code>Subject</code> + <code>debounceTime</code> + <code>distinctUntilChanged</code> + <code>switchMap</code> pipeline (race-proof, minimum 2-character query), plus a <code>/suggest</code> page rebuilding the same pattern to flag close-matching show names.</li>
        </ul>
      </section>
      ...
      <section class="lesson-framework">
        ...
        <ul class="task-checklist">
          <li><span class="checkbox">✅</span> Search "office" on Browse and see real results, race-proof under Slow 3G.</li>
          <li><span class="checkbox">✅</span> Type a single character on Browse and see the "type at least 2 characters" hint, with no request fired.</li>
          <li><span class="checkbox">✅</span> Visit <code>/suggest</code>, type "office", and see "Did you mean The Office?"</li>
      ...
      <div class="warning-box">
        If any of those checks fail, don't push forward into Day 17 yet — go back to the specific day/act that built it (Day 13 for live search, Day 14 for <code>httpResource</code>, Day 15 for the ticker/top-rated/keyboard shortcut, Day 16 for the debounced typeahead and <code>/suggest</code>) and get it working first. Everything today builds on top of this exact state.
      </div>

      <div class="nav-footer">
        <a routerLink="/day16/lab" class="btn-secondary">← Day 16 Lab</a>
        <a routerLink="/day17/act1" class="btn-primary">Act 1: Pipes on Real Data →</a>
      </div>
    </div>
  `
})
export class Day17StartComponent {
  cloneCommand = `git clone https://github.com/megabottty/mtech-angular-lab-data-binding.git
cd mtech-angular-lab-data-binding/starters/bingeboard-day17
npm install
npm start`;
